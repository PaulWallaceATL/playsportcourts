	...
	return (
		<div className="mx-auto max-w-screen-2xl px-4 sm:px-6 lg:px-8 pad-section">
			...
			<div className="mt-6 grid gap-6 lg:grid-cols-[240px_1fr]">
				<aside className="surface-elevated rounded-lg p-4 h-fit">
				...
				<section className="min-h-[320px] surface-elevated rounded-lg p-6 flex items-center justify-center text-muted-foreground">
